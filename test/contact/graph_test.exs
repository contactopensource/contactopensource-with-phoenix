defmodule Contact.GraphTest do
  ...
  describe "edges" do
    ...
    test "create_edge/1 with valid data creates a edge" do
      ...
      assert edge.unit_interval == Decimal.new("120.5")
      assert edge.dual_interval == Decimal.new("120.5")
    ...
    test "update_edge/2 with valid data updates the edge" do
      ...
      assert edge.unit_interval == Decimal.new("456.7")
      assert edge.dual_interval == Decimal.new("456.7")
