defmodule Contact.Qualia.ColorTheme do
  use Ecto.Schema
  ...
  def changeset(color_theme, attrs) do
    color_theme
    |> cast(attrs, [:updated_at_timestamp_utc, :updated_at_clock_count, :updated_by_uri, :tenant_uri, :type_uri, :state_uri, :primary_color_id, :secondary_color_id, :tertiary_color_id, :success_color_id, :failure_color_id, :light_color_id, :dark_color_id, :safety_color_id, :caution_color_id, :warning_color_id, :danger_color_id, :rag_status_r_color_id, :rag_status_a_color_id, :rag_status_g_color_id])
    |> validate_required([:updated_at_timestamp_utc, :updated_at_clock_count, :updated_by_uri, :tenant_uri, :type_uri, :state_uri, :primary_color_id, :secondary_color_id, :tertiary_color_id, :success_color_id, :failure_color_id, :light_color_id, :dark_color_id, :safety_color_id, :caution_color_id, :warning_color_id, :danger_color_id, :rag_status_r_color_id, :rag_status_a_color_id, :rag_status_g_color_id])
  end
end
